...
#include "dgCompressiblePressureMachTemperatureBoundaryField.H"
#include "addToRunTimeSelectionTable.H"

namespace Foam
{

defineTypeNameAndDebug(dgCompressiblePressureMachTemperatureBoundaryField, 0);
addToRunTimeSelectionTable
(
    dgCompressibleBoundaryField,
    dgCompressiblePressureMachTemperatureBoundaryField,
    dictionary
);
