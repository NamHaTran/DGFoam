...
)
{
    ...
    for (label gp = 0; gp < nGauss_; ++gp)
    {
        ...
        {
            case dgCellType::HEX:
                Foam::computeFaceBasisAndDerivativesOfHex(
            ...
            case dgCellType::PRISM:
                Foam::computeFaceBasisAndDerivativesOfPrism(
                    eta1, eta2, eta3, pOrder_,
            ...
            case dgCellType::TET:
                Foam::computeFaceBasisAndDerivativesOfTet(
                    eta1, eta2, eta3, pOrder_,
            ...
            case dgCellType::PYRAMID:
                Foam::computeFaceBasisAndDerivativesOfPyramid(
                    eta1, eta2, eta3, pOrder_,
